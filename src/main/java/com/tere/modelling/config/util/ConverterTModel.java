...
public class ConverterTModel<T extends TModelConverter>
{
	public Logger log = LogManager.getLogger(ConverterTModel.class);
	private T converter;

	public ConverterTModel(T converter)
	{
...
//	{
//		ConverterTModel<EcoreToTModelConverter> converter = new ConverterTModel<EcoreToTModelConverter>(new EcoreToTModelConverter());
//		if (args.length < 2)
//		{
